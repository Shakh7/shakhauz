...
export const Badge = ({text, href}: { text: string; href: string }) => {
    return (
        <Link
            href={href}
            className="bg-gray-900 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6  text-white inline-block"
        >
